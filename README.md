...
This is a tool to crack Bangladesh facebook account.  You do not need to log in.  This tool will help you to crack facebook account fast
...
$ git clone https://github.com/RedHackkErR/FAcebook.git
$ cd FAcebook
$ ls
$ chmod +x *
$ python2 MassTool.py
